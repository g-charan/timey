...
(function(module, exports) {
  ...
  var url = require$$0, path2 = require$$4$1, Stream = require$$0$1.Stream, abbrev2 = abbrevExports, os2 = require$$4;
  ...
  function nopt2(types2, shorthands, args, slice) {
    ...
    clean(data, types2, exports.typeDefs);
    data.argv = argv;
      ...
      val = val.map(function(val2) {
        ...
        if (!validate2(d, k, val2, types2[k], typeDefs)) {
          if (exports.invalidHandler) {
            exports.invalidHandler(k, val2, types2[k], data);
...
function requireBuffer_list() {
  ...
  var _require = require$$0$4, Buffer = _require.Buffer;
...
function requireDetectLibc() {
  ...
  const { LDD_PATH, readFile: readFile2, readFileSync } = requireFilesystem();
...
function requirePreBinding() {
  ...
  (function(module, exports) {
    ...
    const napi2 = requireNapi();
    const existsSync = fs$1.existsSync || require$$4$1.existsSync;
    const path2 = require$$4$1;
    module.exports = exports;
...
function requireNodePreGyp() {
  ...
  (function(module, exports) {
    ...
    const inherits2 = require$$0$3.inherits;
    const cli_commands = [
      "clean",
      "install",
      "reinstall",
...
const getAddon = () => {
  ...
  return fs.existsSync(bindingPath) ? require2(bindingPath) : {
    getActiveWindow() {
    },
    getOpenWindows() {
    }
